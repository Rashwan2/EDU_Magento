...
namespace EDU\SupportTickets\Controller\Account;
...
class Tickets implements HttpGetActionInterface
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        if (!$this->customerSession->isLoggedIn()) {
            $this->customerSession->setAfterAuthUrl('supporttickets/account/tickets');
