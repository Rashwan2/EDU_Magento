    ...
    public function execute()
    {
        ...
        foreach ($blogIds as $blogId) {
            try {
                ...
                $this->messageManager->addErrorMessage(__('Error archiving blog ID %1: %2', $blogId, $e->getMessage()));
            }
        }

        $this->messageManager->addSuccessMessage(__('A total of %1 blog article(s) have been archived.', $blogArchived));
